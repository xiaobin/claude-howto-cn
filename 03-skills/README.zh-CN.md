...
有关详细检查清单，参见 [templates/review-checklist.zh-CN.md](templates/review-checklist.zh-CN.md)。
```
...
有关代码异味目录，参见 [references/code-smells.zh-CN.md](references/code-smells.zh-CN.md)。
有关重构技术，参见 [references/refactoring-catalog.zh-CN.md](references/refactoring-catalog.zh-CN.md)。
```
