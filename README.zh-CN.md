...
参加[自我评估测验](LEARNING-ROADMAP.zh-CN.md#-find-your-level)，或在 Claude Code 中运行 `/self-assessment`。根据你已掌握的知识获得个性化路线图。
...
**[开始学习路线图 ->](LEARNING-ROADMAP.zh-CN.md)** | **[浏览功能目录](CATALOG.zh-CN.md)** | **[15 分钟快速上手](#get-started-in-15-minutes)**
